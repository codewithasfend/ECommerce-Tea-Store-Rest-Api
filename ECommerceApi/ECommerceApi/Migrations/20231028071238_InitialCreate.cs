        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "blacktea.jpg", "Green Tea" },
                    { 3, "blacktea.jpg", "White Tea" },
                    { 4, "blacktea.jpg", "Oolong Tea" },
                    { 5, "blacktea.jpg", "Caffeine Free " }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "A customer favorite. Start your day in a bold way with our loose leaf organic Earl Grey Crème tea. This is a remarkable black tea blend that is hand blended with fragrant oil of bergamot for citrus notes followed by a touch of French vanilla for a rich and robust finish.", "earlgreycreme.jpg", false, false, "Earl Grey Crème Tea", 28.0 },
                    { 3, 1, "Packed with flavor, our traditional blend of organic loose leaf black tea is perfect for starting the day. This robust black tea brews smooth and malty, with a clean finish.", "englishbreakfast.jpg", false, false, "English Breakfast Tea", 20.0 },
                    ...
                    { 10, 2, "An organic green tea that has been repeatedly baked and scented with fresh and fragrant night-blooming jasmine blossoms. This jasmine green tea has beautiful floral and sweet notes.", "jasminetea.jpg", false, false, "Jasmine Reserve Tea", 30.0 },
                    ...
                    { 16, 3, "A dreamy, tropical coconut white tea. White Coconut Crème tea has a light body and smooth creamy texture. A customer favorite both hot and iced.", "whitecoconutcreme.jpg", false, false, "White Coconut Crème Tea", 29.0 },
                    ...
                    { 24, 5, "Our Egyptian Chamomile elicits sweet, calming flavor notes. This tisane is round and soothing with each and every sip, perfect for any time of day.", "egyptianchamomile.jpg", false, false, "Egyptian Chamomile Tea", 20.0 },
                    { 25, 5, "This vanilla rooibos tea is a delectable infusion of enticingly sweet and tangy flavors harmoniously complimented by the soothing smoothness of fresh cream. Our Vanilla Berry Truffle tea is an enjoyable dessert blend at any time of day.", "vanillaberrytruffle.jpg", false, false, "Vanilla Berry Truffle Tea", 25.0 },
                    { 26, 5, "Our Lemon Meringue tea has a light, fluffy texture and a sweet, creamy finish. This rooibos based blend is a delight for any moments of sweet cravings throughout the day.", "lemonmeringue.jpg", false, true, "Lemon Meringue Tea", 21.0 }
                });
